package com.senai.Atividade_Pontuada_API_REST_Spring_Boot.service;

import com.senai.Atividade_Pontuada_API_REST_Spring_Boot.exception.EmailJaCadastradoException;
import com.senai.Atividade_Pontuada_API_REST_Spring_Boot.model.Funcionario;
import com.senai.Atividade_Pontuada_API_REST_Spring_Boot.repository.FuncionarioRepository;
...
public class FuncionarioService {
    ...
    public Funcionario salvar(@Valid Funcionario funcionario) {
        if(funcionarioRepository.findByEmail(funcionario.getEmail()).isPresent()) {
            throw new EmailJaCadastradoException("Este funcionário já possui cadastro.");
        }
