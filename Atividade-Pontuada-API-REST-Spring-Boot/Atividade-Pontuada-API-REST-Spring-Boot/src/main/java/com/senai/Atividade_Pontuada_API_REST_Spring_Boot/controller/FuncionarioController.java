...
import com.senai.Atividade_Pontuada_API_REST_Spring_Boot.service.FuncionarioService;
...
public class FuncionarioController {
    ...
    public ResponseEntity<Map<String, Object>> salvar(@Valid @RequestBody Funcionario funcionario) {
        ...
        return ResponseEntity
                ...
                .body(Map.of("mensagem", "O funcionário foi cadastrado com sucesso!"));
    }
    ...
    public ResponseEntity<Map<String, Object>> atualizar(@Valid @RequestBody Funcionario funcionario) {
        ...
        return ResponseEntity
                .ok()
                .body(Map.of("mensagem", "O funcionário foi atualizado com sucesso!"));
    }
    ...
    public ResponseEntity<Map<String, Object>> excluir(@PathVariable Long id) {
        ...
        return ResponseEntity
                .ok()
                .body(Map.of("mensagem", "O funcionário foi excluido com sucesso!"));
    }
}